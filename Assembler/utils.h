...
typedef enum {FALSE = 0,
              TRUE = 1} boolean; /*used for boolean variable definition*/

typedef enum {AS = 1,
              OB = 2,
              ENT = 3,
              EXT = 4} fileType;/*used for files types*/

typedef enum {NO_ADDRESS_MODE = -1,
              IMMEDIATE = 0,
              DIRECT = 1,
              RELATIVE = 2,
              REGISTER_DIRECT = 3} addressingMode;/*used for addressing mode types*/
